...
def get_activities_sorted_by_date(request, mmdb, query, is_head):
    """
    """
    return mmdb.activity.search(query, count=is_head, sort='_id', flatten=1, keep_private_fields=False, **searchParams(request))


def get_activities_sorted_by_last_comment_date(request, mmdb, query, is_head):
    """
    """
...
def get_activities_sorted_by_like_count(request, mmdb, query, is_head):
    """
    """
...
def get_activities_sorted_by_flagged_first(request, mmdb, query, is_head):
    """
    """
