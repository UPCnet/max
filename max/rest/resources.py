PUBLIC_RESOURCES = {
    ...
    'contexts': {'route': '/contexts', 'category': 'Contexts', 'name': 'Contexts', 'traverse': '/contexts'},
    ...
    'public_contexts': {'route': '/contexts/public', 'category': 'Contexts', 'name': 'Public contexts', 'traverse': '/contexts'},
...
RESTRICTED_RESOURCES = {
    ...
    'maintenance_exceptions': {'route': '/admin/maintenance/exceptions', 'category': 'Management', 'name': 'Error Exception list'},
